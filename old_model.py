...
def main():
    train_data = pd.read_csv('/media/akash/This is Storage/Sem VI/ML Lab Project/sign_mnist_train.csv', sep=',',
                             header=None, low_memory=False)
    # print(train_data.head(n=5))
    test_data = pd.read_csv('/media/akash/This is Storage/Sem VI/ML Lab Project/sign_mnist_test.csv', sep=',',
                            header=None, low_memory=False)
    ...
    print("L:", len(only_test_pixels), "IL:", len(only_test_pixels[2]), "Vals:", len(observed_test_values),
          len(observed_test_values[0]))
    ...
    model = load_model('cnn_model.h5',
                       custom_objects={'loss_categorical_crossentropy': losses.categorical_crossentropy})
